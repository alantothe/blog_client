    ...
    <div className="bg-white min-h-screen flex items-start justify-center pt-20">
      <section className="bg-gray-300 p-10 rounded-lg w-11/12 sm:w-4/5 md:w-1/2 lg:w-1/3 xl:w-1/4 border border-gray-200">
        <header className="text-center">
          <h1 className="text-4xl font-bold mb-10 text-black">Registration Page</h1>
        </header>
        ...
        <form onSubmit={handleRegister} className="flex flex-col items-center">
          ...
          <button type="submit" className="bg-gray-500 text-white rounded px-5 py-2 mb-6 w-full">Register</button>
        </form>
      </section>
    </div>
  );
